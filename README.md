...
- Cloudinary is configured for media storage where required.
...
Stores personal details associated with an authenticated user.

The profile is linked to the Django user account and supports create, read, update, and delete operations.

### NutritionPlan

Stores nutrition products available for customers to browse and purchase.
...
Stores workout products available for customers to browse and purchase.
...
![GitHub Project Board](static/images/github-project-board.webp)
...
- Stripe
- Cloudinary
- PostgreSQL where configured for production
...
|---|---|---|---|
| Navbar | Click all navigation links | Correct pages open | PASS |
| Mobile Navbar | Open navigation on small screen | Menu opens and closes correctly | PASS |
| Register | Submit valid registration | Account is created | PASS |
| Invalid Registration | Submit invalid/incomplete data | Validation errors appear | PASS |
| Login | Enter valid credentials | User logs in | PASS |
| Invalid Login | Enter invalid credentials | Login error appears | PASS |
| Logout | Select Logout | User is logged out | PASS |
| Create Profile | Submit valid personal details | Details are saved | PASS |
| Edit Profile | Change saved information | Updated details are displayed | PASS |
| Delete Profile | Confirm deletion | Personal details are removed | PASS |
| Nutrition Plans | Browse plan page | Plans display correctly | PASS |
| Workout Plans | Browse plan page | Plans display correctly | PASS |
| Add to Cart | Select a plan | Plan appears in cart | PASS |
| Cart Count | Add products | Navbar cart count updates | PASS |
| Update Quantity | Change quantity and update | Quantity and totals update | PASS |
| Remove Item | Click Remove | Confirmation is requested | PASS |
| Cancel Removal | Select Cancel in confirmation | Product remains in cart | PASS |
| Confirm Removal | Confirm removal | Product is removed | PASS |
| Checkout | Submit valid checkout details | User proceeds to Stripe | PASS |
| Invalid Checkout | Submit invalid data | Validation prevents submission | PASS |
| Stripe Test Payment | Complete a valid test payment | Payment succeeds | PASS |
| Checkout Success | Return after successful payment | Confirmation page appears | PASS |
| Cart After Payment | Complete payment | Cart is cleared | PASS |
| Order History | Open My Orders when logged in | User's orders are displayed | PASS |
| Responsive Layout | Test desktop/tablet/mobile | Content remains usable | PASS |

> Review each PASS value against your final deployed application before submission. Change any result that has not yet been personally tested.
...
![Lighthouse Results](static/images/lighthouse-validation.webp)

> Add your final Lighthouse screenshot and record the final scores here.
...
![JavaScript Validation](static/images/javascript-validation.webp)

> Replace these screenshot filenames with the files you actually add to your project.
...
- Suggesting improvements to Django views, templates, forms, and models.
- Supporting implementation and review of shopping cart and checkout functionality.
- Assisting with Stripe integration troubleshooting.
- Supporting responsive and accessibility improvements.
- Helping identify Lighthouse performance improvements.
- Supporting JavaScript implementation for alerts, deletion confirmation, and checkout interaction.
...
Thanks to the tutors, mentors, and course support staff who provided guidance and feedback throughout the development of NutriFit Healthy.
